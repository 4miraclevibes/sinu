...
<div class="container">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 text-center p-0">
            <img src="https://pcnucilacap.com/wp-content/uploads/images/2022/11/talluq-masyayikh-NU.png" class="img-fluid" alt="Banner Image">
        </div>
    </div>
    <div class="row">
...
<div class="container my-5" id="program">
    <h2 class="mb-4 text-center">Program Unggulan NU</h2>
    <div class="row">
        @foreach ($announcements->where('category', 'Program') as $announcement)
        <div class="col-md-3 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <span class="badge bg-primary mb-2 text-end"><a href="{{ route('program', $announcement->id) }}" class="text-white text-decoration-none">Lihat Detail</a></span>
