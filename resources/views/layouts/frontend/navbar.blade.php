    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                @endif
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('berita*') ? 'active' : '' }}" href="{{ route('berita') }}">Berita</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('aktifitas*') ? 'active' : '' }}" href="{{ route('aktifitas') }}">Aktifitas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('pengumuman*') ? 'active' : '' }}" href="{{ route('pengumuman') }}">Pengumuman</a>
                </li>
                <li class="nav-item">
